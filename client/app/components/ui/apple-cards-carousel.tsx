...
import { IconArrowNarrowUp, IconArrowNarrowDown, IconX } from "@tabler/icons-react";
  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="rounded-3xl bg-gray-100 dark:bg-neutral-900 w-full h-[20rem] overflow-hidden flex flex-col items-start justify-start relative z-10"
