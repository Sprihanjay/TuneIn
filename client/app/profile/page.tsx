...
const Applied = () => {
  ...
  const user = useAuth(); // Hook to get the current user
    ...
    const fetchAppliedItems = async () => {
      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          // Fetch details of each applied item if needed
          // Here we're assuming applied contains post IDs
          // You might need to adjust this based on your data structure
          console.log("Found applied gigs");
          setAppliedItems(applied); // Assuming applied is an array of item IDs or data
        } else {
